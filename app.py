...
st.set_page_config(page_title="DM Helper", layout="wide")
...
st.title(":dragon: DM Helper :game_die: ")
st.markdown(
    """ 
        > :black[**A Chatbot that remembers your world and helps write your campaign,**  *powered by -  [LangChain](https://langchain.readthedocs.io/en/latest/modules/memory.html#memory) + 
...
with st.sidebar:
    st.video("https://youtu.be/cHjlperESbg")
    st.markdown(
        """
    **Read my blog Post:** 
    ...
    *Codes are avaialble in this blog post.*
    ...
    # st.markdown("*Blog + Code will be available shortly.* ")
